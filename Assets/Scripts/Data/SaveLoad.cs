...
public class SaveLoad : MonoBehaviour
{
    ...
    const string completedChallenges = "CompletedChallenges";

    const string unlockedCharactersKey = "UnlockedCharacters";
    const string unlockedMusicKey = "UnlockedMusic";
    const string unlockedDanceStylesKey = "UnlockedDanceStyles";
    ...
    public string GetUnlockedCharactersKey() { return unlockedCharactersKey; }
    public string GetUnlockedMusicKey() { return unlockedMusicKey; }
    public string GetUnlockedDanceStylesKey() { return unlockedDanceStylesKey; }
    public string GetCompletedChallengesKey() { return completedChallenges; }
